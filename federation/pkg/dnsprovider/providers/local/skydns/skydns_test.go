...
import (
	...
	skydnstesting "k8s.io/kubernetes/federation/pkg/dnsprovider/providers/local/skydns/stubs"
...
func newFakeInterface() (dnsprovider.Interface, error) {
	var service skydnstesting.EtcdKeysAPI
	service = skydnstesting.NewEtcdKeysAPIStub()
	iface := newInterfaceWithStub(service)
	iface.domain = "example.com"
	iface.etcdPathPrefix = "skydns"
